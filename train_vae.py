...
def train(args):
    ...
    acc_steps = train_config['autoencoder_acc_steps'] #1
    ...
    for epoch_idx in range(num_epochs):
        ...
        for im in tqdm(data_loader):
            ...
            g_loss = recon_loss + (train_config['kl_weight'] * kl_loss / acc_steps) #kl_weight: 0.000005
